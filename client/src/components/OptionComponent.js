...
export default function OptionComponent({ data }) {
    ...
    return (
        <div className="relative" onDoubleClick={(e) => e.stopPropagation()}>
            <svg className="w-[36px] h-[36px] p-2 rounded-full cursor-pointer hover:bg-teal-200" onClick={() => { setShowDropdown(true); }} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
